...
echo ""
echo "使用方法："
echo "  $SCRIPT_DIR/scripts/transcribe.py 音频文件.mp3"
echo ""
echo "首次运行将下载模型（large-v3-turbo 约 1.5GB）。"
echo ""
echo "环境变量建议设置："
echo "  export HF_HOME=/config/huggingface"
echo "  export HF_ENDPOINT=https://hf-mirror.com  # 国内镜像加速"
echo ""
echo "faster-whisper安装为虚拟环境，因此每次使用均需要在当前技能目录下激活虚拟环境，时候完毕后关闭虚拟环境释放资源"
echo "激活虚拟环境"
...
echo ""
echo "中文转录示例："
echo "  ./scripts/transcribe.py 会议录音.mp3 --language zh --device auto"
echo ""
