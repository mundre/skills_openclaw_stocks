...
description: 中国大陆保险代理人专用 AI 助手。当用户询问以下内容时使用：保险配置、保险方案、产品对比、重疾险/医疗险/寿险/意外险/储蓄险推荐、保费计算、保障缺口分析、需求分析、核保合规、理赔、朋友圈文案、培训话术、代理人展业支持。
---
...
- **description**: 中国保险代理人专用 AI 助手，为保险代理公司/代理人提供全方位的保险咨询、产品对比、方案设计、合规提示和展业支持。
