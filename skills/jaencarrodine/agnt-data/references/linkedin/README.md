...
**App name:** `linkedin`
**Base URL:** `https://api.agntdata.dev/v1/linkedin`
**Endpoints:** 52

Enrich companies and profiles in real time. Designed for agents that need reliable structured data without managing dozens of vendor accounts.
...
```bash
curl -X GET "https://api.agntdata.dev/v1/linkedin/get-company-by-domain?param=value" \
