...
## 🚀 简单使用示例
- **发送消息**  
  发送WA消息 用 8613800138000 给 8613900139000 发 你好
- **发送图片**  
  发送图片 用 8613800138000 给 8613900139000 发 https://xxx.com/img.jpg
- **查询聊天记录**  
  查询聊天记录 8613800138000 与 8613900139000
- **设置回调**  
  设置WebHook回调 https://xxx.com/callback
- **查询消息状态**  
  查询消息状态 123456
- **查询账号状态**  
  查询账号状态 8613800138000  
  查询账号在线状态 8613800138000
