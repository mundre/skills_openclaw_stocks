---
name: xiapi-screener
description: '基于技术形态筛选A股股票，获取VCP、RPS强势股、创新高、高股息等形态股票。触发词：股票筛选、选股、VCP形态、RPS强势股、创新高、技术形态、形态选股、自下而上选股。适用场景：技术形态选股、趋势跟踪、动量选股、价值选股。不适用场景：个股深度基本面分析、财报研究、估值建模。'
---
...
**具体触发词**：股票筛选、选股、VCP形态、RPS强势股、创新高、技术形态、形态选股、自下而上选股
