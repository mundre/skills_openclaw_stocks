...
name: video-rotate
version: "1.0.0"
displayName: "Video Rotate - Rotate and Flip Video Orientation with AI"
description: >
  Video rotate tool that rotates and flips video orientation through AI chat. Upload a
  video filmed in the wrong orientation and fix it instantly: "rotate 90 degrees
  clockwise" or "flip horizontally" or "turn upside down." The AI handles 90, 180,
  and 270 degree rotations, horizontal and vertical flipping, and custom angle
  rotation for slightly tilted footage. Fix sideways phone videos, correct upside-down
  camera recordings, mirror footage for specific effects, and straighten tilted shots.
  Combine rotation with other edits in one session: rotate, then crop, add subtitles,
  and export. Batch rotate multiple clips to the same orientation. Preserves original
  resolution and quality. No re-encoding quality loss. Export as MP4. Supports mp4,
  mov, avi, webm, mkv.
metadata: {"openclaw": {"emoji": "🎬", "requires": {"env": [], "configPaths": ["~/.config/nemovideo/"]}, "primaryEnv": "NEMO_TOKEN"}}
---

# Video Rotate - Fix the Wrong Angle
...
**Quick fix**: "Rotate 90 clockwise" is the most common fix for sideways phone videos.

**Mirror**: "Flip horizontally" creates a mirror image — useful for selfie camera correction.

**Straighten**: "Straighten the horizon" fixes slightly tilted handheld footage.
