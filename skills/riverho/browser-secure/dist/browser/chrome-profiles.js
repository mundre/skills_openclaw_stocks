...
export function getProfileById(profileIdOrName) {
...
export function createChromeProfile(name) {
    const userDataDir = getChromeUserDataDir();
    ...
    fs.writeFileSync(path.join(profilePath, 'Preferences'), JSON.stringify(preferences, null, 2));
    return {
        id: profileId,
        name: name,
        path: profilePath,
