#!/usr/bin/env bash
# appsmith - Multi-purpose utility tool
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${APPSMITH_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/appsmith}"
...
case "${1:-help}" in
    ...
    info) shift; cmd_info "$@" ;;
    help|-h) show_help ;;
    version|-v) echo "appsmith v$VERSION" ;;
