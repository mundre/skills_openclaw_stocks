...
```bash
# Get video transcript (cleaned text)
bash scripts/youtube.sh transcript <URL> [--lang LANG]

# Get video metadata
bash scripts/youtube.sh info <URL>

# List channel videos
bash scripts/youtube.sh channel <CHANNEL_URL> [limit]

# Search YouTube
bash scripts/youtube.sh search "query" [limit]
```
...
bash scripts/youtube.sh ai-summary <URL>

# Extract key takeaways
bash scripts/youtube.sh ai-takeaways <URL>

# Compare multiple videos
bash scripts/youtube.sh ai-compare <URL1> <URL2> [URL3...]

# Ask a question about a video
bash scripts/youtube.sh ai-ask <URL> "Your question here"
```
