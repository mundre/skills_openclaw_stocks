...
### Core Components
1. **Text-to-Speech**: Piper TTS with Lessac High Quality voice
...
- ✅ **High quality** - Lessac voice with excellent articulation
...
### Changing the Voice
1. Download desired voice from [Piper Voices](https://huggingface.co/rhasspy/piper-voices)
