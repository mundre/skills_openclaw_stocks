---
name: bocha-search-advanced
description: 博查搜索 (Bocha Search) 的技能，提供增强的网页搜索能力。当用户需要通过博查搜索 API 进行网页搜索、获取联网信息、查找最新资讯或中文内容时使用此技能。适用于 AI Agent 需要联网搜索、RAG 应用获取网页摘要、中文内容检索等场景。
env:
  BOCHA_API_KEY:
    description: 博查搜索 API 密钥
    required: true
---
